var _parse = (function(_parse) {
	...
	var parseShortRaw = [
		...
		'[hit]Рассекающий удар {actor} нанес {value} единиц(у|а|ы) урона {victim}.',
		'[hit]{actor} проводит сногсшибательный прием, {victim} падает и теряет {value} HP.'
		...
		'[rest]«Дела делами, а отдыхать и кушать надо — все-таки не из железа и камня я сделано.»',
