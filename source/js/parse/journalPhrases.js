module.exports = [
	...
	'[hit]Магией {actor} изменяет внутреннюю структуру противника. Перебои в работе сердца наносят {victim} урон в размере {value} HР.',
	...
	'[eva,companion]Не позволив {victim} нанести атаку, {companion} не получает урона.',
	'[eva,companion]«Ха-ха! Съел(а|о|и)?» – крикнул(а|и) {actor}, когда {companion} отвлек(ла|ло|ли) {victim}, сорвав (тому|той|тем) атаку.',
	'[eva,companion]«Что? Не вышло!?» – крикнул(а|и) {actor}, когда {companion} отвлек(ла|ло|ли) {victim}, не позволив (тому|той|тем) атаковать.',
...
//		'[coins]{} споткнул(ся|ась|ось|ись) о камень, а это оказался кошель с {value} монетами! Вот так повезло!',
	...
	'[coins]Пытаясь продать {item}, {} рассказал(а|о) торговцу, через какие испытания прошла эта штуковина. Тот заявил, что подобной рухляди место в музее, но сюжет истории оценил в {value} монет(а|у|ы).',
...
//			'[drop]Короткая вспышка — и {} с удивлением смотр(ит|ят) на горстку пепла, оставшуюся от {drop}.', //manual drop
	...
	'[fight]{actor} приглянулись доспехи {victim}, и он(а|о|и) решил(а|о|и) силой заполучить их себе.',
	'[fight]Учуяв запах припасов, {actor} подкрал(ся|ась|ось) к {victim} сзади, ухватил(ся|ась|ось) за рюкзак и пытается утащить его в кусты, желая завладеть аппетитным содержимым. «А ну-ка прочь от моего добра!» – прогоняет {actor} {victim}.',
	'[fight]«И да падёт {victim} в пыль к ногам моим. Ибо!… Ибо… Впрочем, неважно. Приступим».',
	'[fight]«Это моя дорога! Хочешь идти дальше? Плати!» – заявил(а|о|и) {actor}. «Платить {actor}? Ну уж нет», – молвил(а|о|и) {victim}.',
