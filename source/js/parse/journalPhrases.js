module.exports = [
	...
	'[eva]{companion} толкнул(а|о|и) {victim}, не позволив тем самым атаковать {actor}.',
	'[eva]Удивительно ловко двигаясь, {companion} отвлек(ла|ли) внимание {victim} на себя.',
	'[eva]{victim} уже был(а|о|и) готов(а|ы) убить {actor}, но положение спас(ла|ло|ли) {companion}, неожиданно налетев на врага откуда-то сбоку!',
	'[eva]{victim} был(а|о|и) готов(а|ы) нанести очень опасную атаку по {actor}, но того не да(ла|ло|ли) сделать {companion}.',
	'[eva]Вовремя помешав {victim}, {companion} удалось и прервать вражескую атаку, и не получить повреждений.',
	'[eva]{companion} отвлек(ла|ло|ли) {victim}, и т(а|о|от) промахнулся.',
	'[eva]{companion} бросается на {victim}, блокируя атаку, и {actor} не получает урон.',
	'[eva]Не позволив {victim} нанести атаку, {companion} не получает урона.',
	'[eva]«Ха-ха! Съел(а|о|и)?» – крикнул(а|и) {actor}, когда {companion} отвлек(ла|ло|ли) {victim}, сорвав (тому|той|тем) атаку.',
	'[eva]«Что? Не вышло!?» – крикнул(а|и) {actor}, когда {companion} отвлек(ла|ло|ли) {victim}, не позволив (тому|той|тем) атаковать.',
	'[eva]Отвлекая врага, {companion} сам(а|о|и) чуть не попал(а|о|и) под удар, но обошлось!',
	'[eva]{companion} отвлек(ла|ло|ли) {victim}, и (тот|та|то|те) промахнул(ся|ась|ось|ись).',

	/* Помощь компаньона, с повреждением */
	'[eva,hit]Отвлекая врага от {actor}, {companion} сам(а|о|и) попал(а|о|и) под удар.',
	'[eva,hit]Спасая {actor}, {companion} принял(а|о|и) удар {victim} на себя.',
	'[eva,hit]«А за это, {victim}, придётся ответить!» – крикнула {actor}, когда {companion} отвлек(ла|ло|ли) врага на себя, получив при этом ранение.',

	/* Удар по компаньону */
	'[mush,hit]{actor} ранил(а|о|и) {companion}.',
	'[mush,hit]Кровь {companion} тугой струёй хлестнула по {victim}. Атака {actor} нашла не ту цель…',
