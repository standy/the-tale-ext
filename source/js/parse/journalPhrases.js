module.exports = [
	...
	'[hit]{actor} наш(ёл|ла|ло|ли) точку опоры и перевернул(а|о|и) {victim}, нанося {value} HP.',
...
//		'[coins]{} споткнул(ся|ась|ось|ись) о камень, а это оказался кошель с {value} монетами! Вот так повезло!',
	...
	'[empty]Обшарив останки призрака, {} наш(ел|ла|ло|ли) от мёртвого осла уши. В смысле, ничего не наш(ел|ла|ло|ли).',
