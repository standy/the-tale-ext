...
//			'[drop]Короткая вспышка — и {} с удивлением смотр(ит|ят) на горстку пепла, оставшуюся от {drop}.', //manual drop
	...
	'[drop]«То совсем пусто, то так густо, что уже и в рюкзак не влезает — придется выкидывать хорош(ий|ую|ое|ие) {item}».',
	...
	'[death]Тело погибш(его|ей|их) {} подёргивает в судороге левой ногой. {} оказался быстрее.',
