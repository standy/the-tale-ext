module.exports = [
	...
	'[eva,companion]{companion} толкнул(а|о|и) {victim}, не позволив тем самым атаковать {actor}.',
	'[eva,companion]Удивительно ловко двигаясь, {companion} отвлек(ла|ли) внимание {victim} на себя.',
	'[eva,companion]{victim} уже был(а|о|и) готов(а|ы) убить {actor}, но положение спас(ла|ло|ли) {companion}, неожиданно налетев на врага откуда-то сбоку!',
	'[eva,companion]{victim} был(а|о|и) готов(а|ы) нанести очень опасную атаку по {actor}, но того не дал(а|о|и) сделать {companion}.',
	'[eva,companion]{victim} был готов нанести очень опасную атаку по Че Геваре, но того не дал сделать северный олень.',
	'[eva,companion]Вовремя помешав {victim}, {companion} удалось и прервать вражескую атаку, и не получить повреждений.',
	'[eva,companion]{companion} отвлек(ла|ло|ли) {victim}, и т(а|о|от) промахнулся.',
	'[eva,companion]{companion} бросается на {victim}, блокируя атаку, и {actor} не получает урон.',
	'[eva,companion]Не позволив {victim} провести атаку, {companion} не получает урона.',
	'[eva,companion]«Ха-ха! Съел(а|о|и)?» – крикнул(а|и) {actor}, когда {companion} отвлек(ла|ло|ли) {victim}, сорвав (тому|той|тем) атаку.',
	'[eva,companion]«Что? Не вышло!?» – крикнул(а|о|и) {actor}, когда {companion} отвлек(ла|ло|ли) {victim}, не позволив (тому|той|тем) атаковать.',
	'[eva,companion]Отвлекая врага, {companion} сам(а|о|и) чуть не попал(а|о|и) под удар, но обошлось!',
	'[eva,companion]{companion} отвлек(ла|ло|ли) {victim}, и (тот|та|то|те) промахнул(ся|ась|ось|ись).',
	'[eva,companion]{companion} самоотверженно бросил(ся|ась|ось|ись) на защиту. Урона он(а|о|и) нанес(ла|ло|ли) немного, но атаку {victim} таки сорвал(а|о|и).',
	'[eva,companion]Уклоняясь от вражеских стрел, заклинаний и меча, {companion} успешно испытывает судьбу и не даёт {victim} атаковать.',
	'[eva,companion]{companion} зашуршал(а|о|и) в кустах и {victim}, испугавшись засады, отступил(а|о|и).',
	'[eva,companion]Это же ужас, летящий на крыльях ночи! {companion} появля(е|ю)тся в самый ответственный момент и спасает {actor} от злодеяний {victim}.',
	'[eva,companion]{companion} незаметно подкрал(ся|ась|ось) сзади и напугал(а|о|и) {victim}, котор(ому|ой|ым) теперь не до атаки.',
	'[eva,companion]Вовремя помешав {}, {companion} сумел(а|о|и) прервать (его|её|их) атаку и не получить повреждений.',
	'[eva,companion]{companion} исполнил(а|о|и) странный, завораживающий танец, и {victim} на мгновение изумлённо замер(ла|ло|ли).',

	/* Помощь компаньона, с повреждением */
	'[hit,companion]Отвлекая врага от {actor}, {companion} сам(а|о|и) попал(а|о|и) под удар.',
	'[hit,companion]Спасая {actor}, {companion} принял(а|о|и) удар {victim} на себя.',
	'[hit,companion]«А за это, {victim}, придётся ответить!» – крикнула {actor}, когда {companion} отвлек(ла|ло|ли) врага на себя, получив при этом ранение.',

	/* Удар по компаньону */
	'[mush,companion]{actor} ранил(а|о|и) {companion}.',
	'[mush,companion]Кровь {companion} тугой струёй хлестнула по {victim}. Атака {actor} нашла не ту цель…',
